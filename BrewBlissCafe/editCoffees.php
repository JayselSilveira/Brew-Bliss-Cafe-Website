<?php
  ...
  if(isset($_POST['update'])){
    ...
    $folder = "uploadedImages/menu/coffees/".$item_image;
    ...
    if(isset($_FILES['item_image'])){
        ...
        $sql1 = "UPDATE coffees SET item_name = '$item_name', item_description = '$item_description', item_price = '$item_price', item_image = '$item_image' WHERE item_id = '$temp1';";
    } else {
        $sql1 = "UPDATE coffees SET item_name = '$item_name', item_description = '$item_description', item_price = '$item_price' WHERE item_id = '$temp1';";
    }
...
<body background="./images/tart.jpg">
    <div class="card" style="height: 110%; margin-top:10%;">
        <div>
            <h4><a href="http://localhost/BrewBlissCafe/adminCoffees.php" style="color:#60371E; margin-left:190px;">Aromatic Coffees</a></h4><hr style="margin-bottom:10px;">
            <h2>Edit Page</h2>
        </div>
        ...
        <?php   // LOOP TILL END OF DATA 
          ...
          ?>
        <div class="form"></div>
        <form action="editCoffees.php?item_id=<?php echo $rows['item_id']?>" method="post" class="edit" enctype="multipart/form-data">
            <div class="field">
                <p>Coffee Name: 
            ...
            <div class="field">
                <p>Image: 
                    ...
                    <h4>Current Image: <input type="image" src="uploadedImages/menu/coffees/<?php echo $rows['item_image'];?>" alt="Uploaded Image" name="currentImage" width=150 height=120></h4>
                </p>
            </div>
            <div class="btn">
