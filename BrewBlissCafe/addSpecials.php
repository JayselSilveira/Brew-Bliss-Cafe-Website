...
if(isset($_POST['submit'])){
    ...
    $sql = "INSERT INTO specials(item_name, item_description, item_price, item_image) VALUES('$item_name', '$item_description', '$item_price', '$item_image');";
    ...
    if($con->query($sql) == true){
        ...
        echo '<script type="text/javascript">
         window.onload = function () { alert("Weekly Special added!"); }
        </script>';  
...
<head>
    ...
    <title>Add a Weekly Special</title>
</head>

<body background="./images/specials.jpg">
    <div class="card">
        <div>
            <h2>Add a Special Dish</h2>
        </div>
        <hr>
        <div class="form"></div>
        <form action="addSpecials.php" method="post" class="addMenu" enctype="multipart/form-data">
            <div class="field">
                <p>Dish Name: 
                    <input type="text" placeholder="Add a Dish Name" name="item_name" required>
                </p>
            </div>
            <div class="field">
                <p>Description: 
            ...
            <div class="btn">
                <input type="submit" value="Add Dish" name="submit">
            </div>
        </form>
    </div>
</body>
