...
<html>
   ...
   <body style="background-color: #60371E; background-image: url(images/dessertbg1.jpg); background-size: auto;">
      ...
      <section class="coffee">
        <div class="title">
          <h2 class="title-text">Delicious <span>Desserts <i class="fa-solid fa-cupcake"></i></span></h2>
        ...
        ?>
            <a href="itemDesserts.php?item_id=<?php echo $rows['item_id'];?>" style="text-decoration: none";><div class="card" style="border:3px solid #FFD7A0; display:inline-block; color:#000; background-color:#FFD7A0; font-size:15px; margin-top:5%; margin-bottom:2%; margin-left:4%; margin-right:3%; box-shadow: 0 4px 8px 0 rgba(0,0,0,0.2); transition:0.3s; width:25%; height:37%; text-align:center;">
