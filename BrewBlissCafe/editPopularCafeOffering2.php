<?php
  ...
  $result1 = $con->query($sql);
    ...
    if(isset($_POST['update'])){
        ...
        $sql1 = "UPDATE popular_cafe_offerings SET item_id = $item_id, item_name = '$item_name' WHERE offering_id = 2;";
...
<body background="./images/puffpastry.jpg">
    <div class="card" style="height: 50%;">
        ...
        <?php
          ...
          ?>
        <form action="editPopularCafeOffering2.php?item_id=<?php echo $rows['item_id']?>" method="post" class="update" enctype="multipart/form-data">
            <div class="field">
                <br>
                <label for="offering">Select a Dessert as a Popular Cafe Offering:</label><br><br>
            ...
            <div class="btn">
                <a href="editPopularCafeOffering2.php?item_id=<?php echo $rows['item_id']?>"><input type="submit" value="Save Changes" name="update"></a>
            </div>
        </form>
    </div> 
    <?php
