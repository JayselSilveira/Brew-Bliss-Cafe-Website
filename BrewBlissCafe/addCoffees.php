...
if(isset($_POST['submit'])){
    ...
    $sql = "INSERT INTO coffees(item_name, item_description, item_price, item_image) VALUES('$item_name', '$item_description', '$item_price', '$item_image');";
    ...
    if($con->query($sql) == true){
        ...
        echo '<script type="text/javascript">
         window.onload = function () { alert("Coffee added!"); }
        </script>';  
...
<body background="./images/coffeebg3.jpg">
    <div class="card">
        <div>
            <h2>Add a Coffee</h2>
        </div>
        <hr>
        <div class="form"></div>
        <form action="addCoffees.php" method="post" class="addMenu" enctype="multipart/form-data">
            <div class="field">
                <p>Coffee Name: 
                    <input type="text" placeholder="Add a Coffee Name" name="item_name" required>
                </p>
            </div>
            <div class="field">
                <p>Description: 
            ...
            <div class="btn">
                <input type="submit" value="Add Coffee" name="submit">
            </div>
        </form>
    </div>
</body>
