  ...
  <body>
    ...
    <section class="menu" id="menu" style="background: #FFD7A0; background-image: url(images/dessertbg.jpg)">
      ...
      <div class="content">
          ...
          <div class="card">
            <a href="http://localhost/BrewBlissCafe/coffees.php" class="card-links">
            <div class="imgBx">
        ...
        <div class="card">
          <a href="http://localhost/BrewBlissCafe/desserts.php" class="card-links"></a>
        </a>
          <div class="imgBx">
        ...
        <div class="card">
          <a href="http://localhost/BrewBlissCafe/specials.php" class="card-links"></a>
        </a>
          <div class="imgBx">
