...
if(isset($_POST['delete'])){
    ...
    $sql3 = "DELETE FROM specials WHERE item_id = '$temp';";
    if($conn->query($sql3) == true) {
        echo '<script type ="text/JavaScript">';
        echo 'alert("User deleted successfully!")';
        echo '</script>';
        header("location: adminSpecials.php");
    } else {
...
<body style="background-image: url(images/home.jpg); background-size: 1500px 1000px;">
    ...
    <header>
        ...
        <ul class="navigation">
            <li><form method="post" action="editSpecials.php?item_id=<?php echo $rows['item_id']?>"><a href="editSpecials.php?item_id=<?php echo $rows['item_id']?>"><input type="submit" id="edit" name="edit" value="&#9998;  Edit  " style="font-size: 20px; font-weight: 600; color: #60371E; background: #6ffc8e; padding: 2px 20px;
            margin-left: 10px;"></a></form></li>
            <li><form method="post" action="adminItemSpecials.php?item_id=<?php echo $rows['item_id']?>"><a href="adminSpecials.php?item_id=<?php echo $rows['item_id']?>"><input type="submit" id="delete" name="delete" value="&#10006;  Delete " style="font-size: 20px; font-weight: 600; color: #60371E; background: #f51637; padding: 2px 20px;
            margin-left: 10px;"></a></form></li>
