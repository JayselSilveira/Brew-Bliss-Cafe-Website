...
if(isset($_POST['delete'])){
    ...
    $sql3 = "DELETE FROM desserts WHERE item_id = '$temp';";
...
<body style="background-image: url(images/home.jpg); background-size: 1500px 1000px;">
    ...
    <header>
        ...
        <ul class="navigation">
            <li><form method="post" action="editDesserts.php?item_id=<?php echo $rows['item_id']?>"><a href="editDesserts.php?item_id=<?php echo $rows['item_id']?>"><input type="submit" id="edit" name="edit" value="&#9998;  Edit  " style="font-size: 20px; font-weight: 600; color: #60371E; background: #6ffc8e; padding: 2px 20px;
            margin-left: 10px;"></a></form></li>
            <li><form method="post" action="adminItemDesserts.php?item_id=<?php echo $rows['item_id']?>"><a href="adminDesserts.php?item_id=<?php echo $rows['item_id']?>"><input type="submit" id="delete" name="delete" value="&#10006;  Delete " style="font-size: 20px; font-weight: 600; color: #60371E; background: #f51637; padding: 2px 20px;
            margin-left: 10px;"></a></form></li>
    ...
    <section class="item" id="item">
        <div class="content">
            <div class="card" style="height: 100%; background-color: #FFD7A0;">
                ...
                <div class="imgBx">
                    <img src="uploadedImages/menu/desserts/<?php echo $rows['item_image'];?>" width="700" height="330" style="object-fit:contain">
                </div>
