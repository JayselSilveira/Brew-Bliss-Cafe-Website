...
if(isset($_POST['add'])){
    ...
    if(isset($_POST['add'])){
        $sql1 = "INSERT INTO cart(added_by, item_type, item_id, quantity) VALUES('$added_by', 1, '$item_id', '$quantity');";
        ...
        <div class="content">
            <div class="card" style="height: 100%; background-color: #FFD7A0;">
                ...
                <div class="text">
                    ...
                    <form method="post" action="itemCoffees.php?item_id=<?php echo $rows['item_id'];?>">
